package datas.operacoes.dateTimeFormat;
...
public class HoraRefeicao {
  public void calcularHoraRefeicao() {
    ...
    System.out.println(
        "Segunda refeição do  dia " + formatadorData.format(horaPrimeiraRefeicao.plusHours(3))
            + " deve ser às: " + formatadorHora.format(horaPrimeiraRefeicao.plusHours(3)));


    System.out.println(
        "Terceira refeição do dia " + formatadorData.format(horaPrimeiraRefeicao.plusHours(6))
            + " deve ser às: " + formatadorHora.format(horaPrimeiraRefeicao.plusHours(6)));


    System.out.println(
        "Quarta refeição do dia " + formatadorData.format(horaPrimeiraRefeicao.plusHours(9))
            + " deve ser às: " + formatadorHora.format(horaPrimeiraRefeicao.plusHours(9)));


    System.out.println(
        "Quinta refeição do dia " + formatadorData.format(horaPrimeiraRefeicao.plusHours(12))
            + " deve ser às: " + formatadorHora.format(horaPrimeiraRefeicao.plusHours(12)));


    System.out.println(
        "Sexta refeição do dia " + formatadorData.format(horaPrimeiraRefeicao.plusHours(15))
